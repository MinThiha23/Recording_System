      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md text-center mb-8">
          ...
          <div className="text-white">
            <h1 className="text-3xl font-bold mb-2">PROGRAM MANAGEMENT SYSTEM</h1>
            <h2 className="text-xl font-semibold mb-1">SISTEM PENGURUSAN PROGRAM</h2>
            <p className="text-blue-200 text-sm">Official EXCO YB Portal</p>
            <p className="text-blue-200 text-xs">Portal Rasmi EXCO YB</p>
          </div>
        </div>
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <div className="mt-8 text-center">
            ...
            <p className="text-blue-300 text-xs mt-1">
              For technical support, contact: support@exco.gov.my
            </p>
          </div>
        </div>
      </div>
